...
namespace MinimalAPI.EndPoint
{
    public static class CouponEndpoints
    {
        ...
        {
            app.MapGet("/api/coupons", GetAllCoupon)
            ...
            app.MapPut("/api/coupon", UpdatePost)
        ...
        private static IResult GetCouponById (int id)
        {
            APIResponse response = new();
        ...
        private static async Task<IResult> CreateCoupon ([FromBody] CouponCreateDto createCouponDTO, IMapper mapper, IValidator<CouponCreateDto> _validation)
        {
        ...
        private static async Task<IResult> UpdatePost ([FromBody] CouponUpdateDto couponUpdateDto, IMapper mapper, IValidator<CouponUpdateDto> _validation)
        {
            APIResponse response = new() { IsSuccess = false, StatusCode = HttpStatusCode.BadRequest };
        ...
        private static IResult DeleteCoupon(int id)
        {
            APIResponse response = new() { IsSuccess = false, StatusCode = HttpStatusCode.BadRequest };
